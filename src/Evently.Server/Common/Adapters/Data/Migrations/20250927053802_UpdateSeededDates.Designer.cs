...
namespace Evently.Server.Common.Adapters.Data.Migrations
{
    ...
    partial class UpdateSeededDates
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Evently.Server.Common.Domains.Entities.Booking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDateTime = new DateTimeOffset(new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            GatheringId = 1L
                        },
                        new
                        {
                            ...
                            CreationDateTime = new DateTimeOffset(new DateTime(2025, 1, 1, 1, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            GatheringId = 2L
                        });
                });
            ...
            modelBuilder.Entity("Evently.Server.Common.Domains.Entities.Gathering", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            End = new DateTimeOffset(new DateTime(2026, 12, 5, 17, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Location = "Marina Bay Sands Convention Centre, Singapore",
                            Name = "Tech Innovation Summit",
                            OrganiserId = "empty-user-12345",
                            Start = new DateTimeOffset(new DateTime(2026, 12, 5, 9, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            GatheringId = 2L,
                            ...
                            End = new DateTimeOffset(new DateTime(2026, 12, 10, 22, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Location = "Clarke Quay Central, Singapore",
                            Name = "Startup Networking Night",
                            OrganiserId = "empty-user-12345",
                            Start = new DateTimeOffset(new DateTime(2026, 12, 10, 18, 30, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            GatheringId = 3L,
                            ...
                            End = new DateTimeOffset(new DateTime(2026, 12, 15, 18, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Location = "National Gallery Singapore",
                            Name = "Digital Art Exhibition",
                            OrganiserId = "empty-user-12345",
                            Start = new DateTimeOffset(new DateTime(2026, 12, 15, 10, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            GatheringId = 4L,
                            ...
                            End = new DateTimeOffset(new DateTime(2026, 12, 8, 17, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Location = "Singapore Science Centre",
                            Name = "Web Development Workshop",
                            OrganiserId = "guest-user-22222",
                            Start = new DateTimeOffset(new DateTime(2026, 12, 8, 13, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            GatheringId = 5L,
                            ...
                            End = new DateTimeOffset(new DateTime(2026, 12, 20, 16, 30, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Location = "Raffles City Convention Centre, Singapore",
                            Name = "Business Strategy Seminar",
                            OrganiserId = "guest-user-22222",
                            Start = new DateTimeOffset(new DateTime(2026, 12, 20, 14, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            GatheringId = 6L,
                            ...
                            End = new DateTimeOffset(new DateTime(2026, 12, 22, 12, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Location = "Gardens by the Bay, Singapore",
                            Name = "Photography Masterclass",
                            OrganiserId = "guest-user-22222",
                            Start = new DateTimeOffset(new DateTime(2026, 12, 22, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            GatheringId = 7L,
                            ...
                            End = new DateTimeOffset(new DateTime(2026, 12, 12, 18, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Location = "NUS School of Computing, Singapore",
                            Name = "Mobile App Development Bootcamp",
                            OrganiserId = "empty-user-12345",
                            Start = new DateTimeOffset(new DateTime(2026, 12, 12, 9, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            GatheringId = 8L,
                            ...
                            End = new DateTimeOffset(new DateTime(2026, 12, 25, 17, 30, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Location = "Suntec Singapore Convention Centre",
                            Name = "Investment & Finance Forum",
                            OrganiserId = "empty-user-12345",
                            Start = new DateTimeOffset(new DateTime(2026, 12, 25, 14, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            GatheringId = 9L,
                            ...
                            End = new DateTimeOffset(new DateTime(2026, 12, 28, 15, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Location = "Esplanade Theatres, Singapore",
                            Name = "Creative Writing Workshop",
                            OrganiserId = "guest-user-22222",
                            Start = new DateTimeOffset(new DateTime(2026, 12, 28, 10, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            GatheringId = 10L,
                            ...
                            End = new DateTimeOffset(new DateTime(2026, 12, 30, 17, 30, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Location = "Singapore EXPO",
                            Name = "Cloud Computing Conference",
                            OrganiserId = "empty-user-12345",
                            Start = new DateTimeOffset(new DateTime(2026, 12, 30, 9, 30, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            GatheringId = 11L,
                            ...
                            End = new DateTimeOffset(new DateTime(2027, 1, 3, 18, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Location = "Marina Bay Financial Centre, Singapore",
                            Name = "E-commerce Mastery",
                            OrganiserId = "guest-user-22222",
                            Start = new DateTimeOffset(new DateTime(2027, 1, 3, 13, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            GatheringId = 12L,
                            ...
                            End = new DateTimeOffset(new DateTime(2027, 1, 5, 22, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Location = "Victoria Theatre, Singapore",
                            Name = "Contemporary Dance Performance",
                            OrganiserId = "empty-user-12345",
                            Start = new DateTimeOffset(new DateTime(2027, 1, 5, 19, 30, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            GatheringId = 13L,
                            ...
                            End = new DateTimeOffset(new DateTime(2027, 1, 8, 16, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Location = "Singapore Management University",
                            Name = "Cybersecurity Awareness Training",
                            OrganiserId = "guest-user-22222",
                            Start = new DateTimeOffset(new DateTime(2027, 1, 8, 10, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            GatheringId = 14L,
                            ...
                            End = new DateTimeOffset(new DateTime(2027, 1, 10, 17, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Location = "Orchard Hotel Singapore",
                            Name = "Leadership Excellence Workshop",
                            OrganiserId = "empty-user-12345",
                            Start = new DateTimeOffset(new DateTime(2027, 1, 10, 9, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            GatheringId = 15L,
                            ...
                            End = new DateTimeOffset(new DateTime(2027, 1, 12, 23, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Location = "Singapore International Film Festival Venue",
                            Name = "Film & Media Production Showcase",
                            OrganiserId = "guest-user-22222",
                            Start = new DateTimeOffset(new DateTime(2027, 1, 12, 18, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
